...
struct RunningWorkout {
    ...
    func mileTime() -> Double{
        return(distance * time) / 1600
    }
    
}

var runningThing = RunningWorkout(distance: 1400, time: 15, elevation: 10)

print(runningThing.mileTime())
/*:
...
var stepThing = Steps(steps: 9999, goal: 10000)
