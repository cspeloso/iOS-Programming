...
var colorShapeDictionary: [String: [String]] = ["Shapes": shapesArray, "Colors": colorsArray]
print(colorShapeDictionary)
 ...
 */
if let lastThing = colorShapeDictionary["Colors"]?.last{
    print(lastThing)
}
