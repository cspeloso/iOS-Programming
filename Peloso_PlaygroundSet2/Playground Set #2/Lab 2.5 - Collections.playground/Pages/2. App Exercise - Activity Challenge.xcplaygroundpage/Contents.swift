 ...
 */
var walkingThing: [String] = ["Walk one mile","Walk two miles"]
var runningThing: [String] = ["Run one mile","Run two miles"]
 ...
 */
var challenges = [walkingThing,runningThing];
...
else if selectedChallenges.count == 1{
    print("The challenge you have chosen is \(selectedChallenges[0]).");
}
else{
