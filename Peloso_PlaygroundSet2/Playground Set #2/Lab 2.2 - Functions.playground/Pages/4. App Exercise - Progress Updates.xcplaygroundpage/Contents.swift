...
func progressUpdate(steps: Int, goal: Int){
    if(Double(steps) < (10000 * 0.1)){
        
        print("You're off to a good start.")
        
    }
    else if(steps < 10000/2){
        print("You're almost halfway there!")
    }
    else if(Double(steps) < (10000 * 0.9)){
...
pacing(currentDistance: 12, totalDistance: 30, currentTime: 16, goalTime: 20)
